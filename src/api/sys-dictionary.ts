...
export const createSysDictionary = (data:any) => {
  return service({
...
export const deleteSysDictionary = (data:any) => {
  return service({
...
export const updateSysDictionary = (data:any) => {
  return service({
...
export const findSysDictionary = (params:any) => {
  return service({
...
export const getSysDictionaryList = (params:any) => {
  return service({
